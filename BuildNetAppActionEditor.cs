...
namespace Inedo.BuildMasterExtensions.DotNet2
{
    ...
    /// </summary>
    public class BuildNetAppActionEditor : ActionEditorBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildNetAppActionEditor"/> class.
        /// </summary>
        public BuildNetAppActionEditor()
        {
        ...
        public override void BindToForm(ActionBase extension)
        {
            ...
            var buildAction = (BuildNetAppAction)extension;
        ...
        public override ActionBase CreateFromForm()
        {
            ...
            var buildAction = new BuildNetAppAction();
