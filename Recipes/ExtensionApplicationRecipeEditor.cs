...
using Inedo.BuildMasterExtensions.DotNet2.MSBuild;
using Inedo.Linq;
        ...
        protected override void CreateChildControls()
        {
            ...
            this.WizardStepChange += (s, e) =>
            {
                if (e.CurrentStep != this.wizardSteps.SelectProviderAndSolution)
                    return;
                using (var connection = Util.Providers.ConnectToProvider<SourceControlProviderBase>(ctlSolutionPath.SourceControlProviderId))
                {
