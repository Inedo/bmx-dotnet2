...
namespace Inedo.BuildMasterExtensions.DotNet2
{
    ...
    public sealed class ClickOnceAction : CommandLineActionBase
    {
        #region Properties
        /// <summary>
        ...
        protected override string ProcessRemoteCommand(string name, string[] args)
        {
            string appManifest = Path.Combine(
                RemoteConfiguration.TargetDirectory,
        ...
        {
            var sdkPath = ((DotNetConfigurer)GetExtensionConfigurer()).SdkPath;
